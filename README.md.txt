...
Additionally, unsupervised learning techniques (K-Means,DBSCAN and Isolation Forest) were applied to introduce **Cluster ID** and **Anomaly Detection** as new features.
